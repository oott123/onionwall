...
//访问的端口,http默认是 80
'port'=>80,
//客户端 USERAGENT,如:&quot;Mozilla/4.0&quot;
'userAgent'=>'Mozilla/5.0 (compatible; xlaBot/1.0; http://126.am/aboutxla)',
//连接超时时间
'timeOut'=>5,
...
$header = isset($this->setopt['headers']) ? $this->setopt['headers']:array();
$header[]= 'Expect:';
$header[]= 'X-Forwarded-For: '.$_SERVER['REMOTE_ADDR'];
curl_setopt($this->ch, CURLOPT_HTTPHEADER, $header);
$this->set_ua($this->setopt['userAgent']);
//设置连接等待时间,0不等待
...
$cookfile = $this->setopt['cookieFile'] ? $this->setopt['cookieFile'] : tempnam(sys_get_temp_dir(),'cuk');
//连接关闭以后，存放cookie信息
...
public function set_ua($userAgent){
	//设置 HTTP USERAGENT
...
* @return string || array
*/
public function _parsmEncode($params,$isRetStr=true)
{
$fieldStr = '';
$spr = '';
$result = array();
